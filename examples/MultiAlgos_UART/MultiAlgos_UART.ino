...
void setup() {
    ...
    huskylens.setMultiAlgorithm(ALGORITHM_FACE_RECOGNITION, ALGORITHM_OBJECT_RECOGNITION, ALGORITHM_HAND_RECOGNITION);
...
void loop() {
    ...
    huskylens.setLearningRectPosition(ALGORITHM_OBJECT_RECOGNITION, x1, y1, x2, y2);
    while (1) {
