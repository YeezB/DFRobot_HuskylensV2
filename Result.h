...
enum protocolCommand {
    ...
    COMMAND_SET_BLOCK_POSITION        = 0x34,
    // RFU 0x35 - 0x3F
    ...
    COMMAND_ACTION_DRAW_RECT       = 0x54,
    COMMAND_ACTION_CLEAN_RECT      = 0x55,
    COMMAND_ACTION_DRAW_TEXT       = 0x56,
    COMMAND_ACTION_CLEAN_TEXT      = 0x57,
