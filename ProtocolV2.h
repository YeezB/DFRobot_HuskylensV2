...
class ProtocolV2 {
  public:
    ...
    bool         setLearningRectPosition(eAlgorithm_t algo, int16_t x1, int16_t y1, int16_t x2, int16_t y2);
    ...
    bool         drawRect(eAlgorithm_t algo, uint8_t colorID, int16_t x1, int16_t y1, int16_t x2, int16_t y2);
